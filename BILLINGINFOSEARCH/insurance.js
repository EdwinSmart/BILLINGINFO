const insuranceCompaniesData = [
  {
    ...
    "preAuthorizationServices": ["Speech Therapy", "Surgery", "MRI", "Specialist Consultation", "Vitamin tests", "Pregnancy tests", "HIV test", "Covid-19 tests", "Physiotherapy", "Occupational therapy"],
    "businessSchemes": [
      {
        "name": "",
        "coPay": "",
  ...
  },
{
    ...
    "email": "IADBGeneralQuestions@cignahealthcare.com",
    "outpatientLimit": "CHECK CIGNA PORTAL",
